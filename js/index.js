...
document.addEventListener("mousedown", () => {
    if (game_started && !dino.classList.contains("jump1") && !dino.classList.contains("jump2")){
        dino.classList.add("jump2");

        jump_height = setInterval(() => {
            jump_timing -= 5;
        }, 5);
    }
});
